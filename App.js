...
import dogs from './source/assets/dogs.jpeg'
    ...
    return (
        <View style={styles.container}>
          <View style={styles.nav}>
            <Image source={require('./source/assets/perfil.png')} style={styles.navItenPerfil}  />
            <Image style={styles.navIten} source={require('./source/assets/lupa.png')} />
            <Image style={styles.navIten} source={require('./source/assets/balão.jpeg')} />
          </View>
          <ScrollView >
